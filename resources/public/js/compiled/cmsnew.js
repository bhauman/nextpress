...
goog.addDependency("../cmsnew/publisher/core.js", ['cmsnew.publisher.core'], ['cmsnew.datastore.s3', 'cljs.core', 'cmsnew.edn_page.item', 'cmsnew.edn_page.items.heading', 'cmsnew.util.core', 'cmsnew.transformer.markdown', 'cmsnew.publisher.site', 'cmsnew.edn_page.items.markdown', 'cmsnew.publisher.paths', 'cmsnew.util.async_utils', 'cmsnew.edn_page.items.section', 'cmsnew.publisher.item_templates', 'clojure.string', 'goog.crypt.Md5', 'cljs.reader', 'jayq.util', 'crate.core', 'cljs.core.async', 'cmsnew.edn_page.items.image', 'cmsnew.publisher.source_file']);
