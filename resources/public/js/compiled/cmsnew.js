...
goog.addDependency("../cmsnew/transformer/underscore_template.js", ['cmsnew.transformer.underscore_template'], ['cljs.core']);
...
goog.addDependency("../cmsnew/datastore/core.js", ['cmsnew.datastore.core'], ['cljs.core', 'cljs.core.async']);
...
goog.addDependency("../cmsnew/datastore/s3_store.js", ['cmsnew.datastore.s3_store'], ['cmsnew.datastore.core', 'cmsnew.datastore.s3', 'cljs.core', 'clojure.string']);
goog.addDependency("../cmsnew/publisher/rendering/base.js", ['cmsnew.publisher.rendering.base'], ['cmsnew.transformer.underscore_template', 'cljs.core', 'cmsnew.util.core', 'cmsnew.publisher.paths']);
goog.addDependency("../cmsnew/publisher/plugins/source_file_renderer.js", ['cmsnew.publisher.plugins.source_file_renderer'], ['cmsnew.publisher.rendering.base', 'cljs.core', 'cmsnew.util.core']);
goog.addDependency("../cmsnew/publisher/rendering/edn_page.js", ['cmsnew.publisher.rendering.edn_page'], ['cmsnew.transformer.underscore_template', 'cljs.core', 'cmsnew.edn_page.item', 'cmsnew.edn_page.items.heading', 'cmsnew.edn_page.items.markdown', 'cmsnew.edn_page.items.section', 'clojure.string', 'crate.core', 'cmsnew.edn_page.items.image']);
goog.addDependency("../cmsnew/publisher/logger.js", ['cmsnew.publisher.logger'], ['cljs.core', 'cljs.core.async']);
goog.addDependency("../cmsnew/publisher/plugins/base.js", ['cmsnew.publisher.plugins.base'], ['cmsnew.transformer.underscore_template', 'cmsnew.datastore.core', 'cmsnew.publisher.rendering.base', 'cljs.core', 'cmsnew.publisher.logger', 'cmsnew.publisher.rendering.edn_page', 'cmsnew.util.core', 'cmsnew.publisher.paths', 'cljs.core.async', 'cmsnew.publisher.source_file']);
goog.addDependency("../cmsnew/datastore/localstore.js", ['cmsnew.datastore.localstore'], ['cmsnew.datastore.core', 'cljs.core', 'clojure.string', 'goog.crypt.Md5']);
goog.addDependency("../cmsnew/publisher/default_pipeline.js", ['cmsnew.publisher.default_pipeline'], ['cmsnew.transformer.underscore_template', 'cmsnew.datastore.core', 'cmsnew.datastore.s3_store', 'cljs.core', 'cmsnew.publisher.plugins.source_file_renderer', 'cmsnew.publisher.rendering.edn_page', 'cmsnew.util.core', 'cmsnew.publisher.plugins.base', 'cmsnew.transformer.markdown', 'jayq.util', 'cljs.core.async', 'cmsnew.datastore.localstore']);
goog.addDependency("../cmsnew/publisher/core.js", ['cmsnew.publisher.core'], ['cmsnew.publisher.default_pipeline', 'cmsnew.datastore.core', 'cmsnew.datastore.s3', 'cmsnew.datastore.s3_store', 'cljs.core', 'cmsnew.publisher.rendering.edn_page', 'cmsnew.util.core', 'cmsnew.publisher.site', 'cmsnew.publisher.paths', 'cmsnew.util.async_utils', 'cmsnew.publisher.item_templates', 'clojure.string', 'cljs.reader', 'jayq.util', 'crate.core', 'cljs.core.async', 'cmsnew.datastore.localstore', 'cmsnew.publisher.source_file']);
